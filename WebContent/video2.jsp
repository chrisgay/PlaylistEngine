...
<body>
	...
	<div style="height:300px; width:100%">
		<div style="height:200px; width:33%; background-color:#fff; display:inline-block;">
			...
			<button type="button" name="counter" onclick="myFunction()">Load</button>
			<p id="demo">Practice Type</p>
			
		</div>
		<div style="height:200px; width:33%; background-color:#fff; display:inline-block;">
		
			<h1>Choose Query</h1>
			<button type="button" name="counter" onclick="myFunction()">Query</button>
			<p id="demo">Sample Query</p>
		...
		<div style="height:200px; width:33%; background-color:#fff; display:inline-block;">
			...
			<h1>Load Playlist</h1>
			<button type="button" name="counter" onclick="myFunction()">Load</button>
			<p id="demo">Playlist: Item 1, 2, 3, 4, 5</p>
